...
NCARDS = 8  # number of cards to play in one game


# Pass in a deck and this function returns a random card from the deck
def getCard(deckListIn):
    thisCard = deckListIn.pop()  # pop one off the top of the deck and return it
    return thisCard
...
def shuffle(deckListIn):
    ...
    random.shuffle(deckListOut)      # shuffle the copy
    return deckListOut
...
print('lower than the current card.')
